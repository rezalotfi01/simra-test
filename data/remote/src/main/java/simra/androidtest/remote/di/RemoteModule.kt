package simra.androidtest.remote.di

import simra.androidtest.remote.BuildConfig
import simra.androidtest.remote.MovieService
...
fun remoteModule(baseUrl: String) = module {
    ...
    factory { MovieDataSource(get(), BuildConfig.TOKEN) }
}