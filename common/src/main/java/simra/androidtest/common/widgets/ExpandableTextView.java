package simra.androidtest.common.widgets;
...
/**
 * A third-party library for creating expandable TextView in the case of long texts
 */
...
public class ExpandableTextView extends AppCompatTextView
    ...
    private void initAnimator() {
        ...
        mAnimator.addUpdateListener(valueAnimator -> updateHeight((int) valueAnimator.getAnimatedValue()));
